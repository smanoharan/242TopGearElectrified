...
namespace GameEngine.Particles
{
    ...
    public class ParticleEmitter
    {
        ...
        public void Update(GameTime gameTime, Vector3 newPosition, float particlesPerSecond)
        {
            if (particlesPerSecond < 0.001f) particlesPerSecond = 0.001f;

            timeBetweenParticles = 1.0f / particlesPerSecond;

            Update(gameTime, newPosition);
        }
